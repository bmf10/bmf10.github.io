      ...
      <Row gutter={24}>
        <Col xs={24} sm={10}>
          <ProfilePictureContainer>
            <ProfilePicture
              ...
              preview={false}
              alt="bima febriansyah"
              src="/my.jpg"
            />
            <Typography.Title level={1}>
              Bima Febriansyah (24 y.o)
            </Typography.Title>
          ...
          <MyDescription column={1} title="Contact Me" layout="horizontal">
            ...
            <Descriptions.Item label="WhatApps">
              <a href="https://wa.me/6289693943932">Click Here</a>
            </Descriptions.Item>
          </MyDescription>
          <Divider />
        </Col>
        <Col xs={24} sm={14}>
          ...
          <Typography.Paragraph style={{ textAlign: "justify" }}>
            ...
            Mastering several programming languages such as PHP and
            Javascript/Typescript. Also some additional libraries like Express
            JS & SQL for backend, React & JQuery for frontend, and some css
            libraries/frameworks.
          </Typography.Paragraph>
          <Divider />
          <Typography.Title level={3}>Skills</Typography.Title>
          <Typography.Paragraph>
            Typescript - PHP - MySQL - PostgreSQL - React/Next Js - Express JS -
            Codeigniter - Laravel - Bootstrap - JQuery - Tailwind CSS - Firebase
            - Wordpress - React Native
          </Typography.Paragraph>
          <Divider />
          <Typography.Title level={3}>Languages</Typography.Title>
          <Typography.Paragraph>
            Indonesian (Native)
            <br />
