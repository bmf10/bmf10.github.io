...
const MyResume: FC = () => {
  ...
  return (
    <Container>
      <Header className="text-textNiceOne">{t("myResume")}</Header>
      <div className="relative wrap overflow-hidden sm:px-10 h-full">
        ...
        <div className="border-2-2 absolute bg-gray-300 border-gray-300 h-full border ml-5 sm:ml-0 sm:left-1/2"></div>
        <Timeline
          align="left"
